...
output_file = r"c:\Users\User\Desktop\VSCode\MQL5-Theme\extracted_inp.md"
    ...
    try:
        ...
        with open(input_path, 'r', encoding='utf-8') as f:
            for line_num, line in enumerate(f):
                # Regex to find words starting with Inp or INP
                # \b matches word boundary
                # (?:Inp|INP) matches the prefix non-capturing
                # [a-zA-Z0-9_]+ matches the rest of the identifier
